...
juce::ValueTree PianoRollStateSerialiser::toValueTree(const PianoRollState& state)
{
    ...
    for (const auto& n : state.notes)
    {
        ...
        noteTree.setProperty(PianoRollStateIds::ratioNum,    n.ratioNum,     nullptr);
        noteTree.setProperty(PianoRollStateIds::ratioDen,    n.ratioDen,     nullptr);
                                                       ...
                                                       float /*pitchBendRange*/)
{
    ...
    if (notesTree.isValid())
    {
        ...
        for (int i = 0; i < notesTree.getNumChildren(); ++i)
        {
            ...
            n.start       = static_cast<int>(noteTree.getProperty(PianoRollStateIds::start, 0));
            n.end         = static_cast<int>(noteTree.getProperty(PianoRollStateIds::end, 0));
            ...
            n.ratioNum    = static_cast<int>(noteTree.getProperty(PianoRollStateIds::ratioNum, 1));
            n.ratioDen    = static_cast<int>(noteTree.getProperty(PianoRollStateIds::ratioDen, 1));
